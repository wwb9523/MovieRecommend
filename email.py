...
fromaddr = prompt("48450976@qq.com")
toaddrs  = prompt("431690713@qq.com").split()
subject  = prompt("Subject: test")
...
username = prompt("48450976@qq.com")
password = getpass("wwb13110019598.")
